...
fmrifolder=$7
copenum=$8  # ex. cope2
fmrifolder2=${fmrifolder:9:5}"_Level2.gfeat" # change to 9 after done
...
## Copy zstat files
cp /Volumes/Cabeza/WMTMS.01/Analysis/AllTrials/${modelnumb}/${fmrifolder}/${fmrifolder2}/${copefolder}/stats/zstat1.nii.gz /Volumes/Cabeza/WMTMS.01/Analysis/Efield_Sims/${subIDserver}/E-field/
